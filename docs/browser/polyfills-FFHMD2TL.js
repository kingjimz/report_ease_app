...
function dt() {
  ...
  class t {
    ...
    runTask(s, i, o) {
      ...
      let g = s,
        { type: V, data: { isPeriodic: ee = !1, isRefreshable: Z = !1 } = {} } = s;
    ...
    scheduleTask(s) {
      ...
      try {
        ...
        throw (s._transitionTo(X, k, q), this._zoneDelegate.handleError(this, o), o);
      }
      return (
    ...
    cancelTask(s) {
      ...
      if (!(s.state !== d && s.state !== A)) {
        ...
        try {
          ...
          throw (s._transitionTo(X, x), this._zoneDelegate.handleError(this, i), i);
        }
        return (this._updateTaskCount(s, -1), s._transitionTo(q, x), (s.runCount = -1), s);
      }
    }
  ...
  class f {
    ...
    constructor(s, i, o) {
      ((this._taskCounts = { microTask: 0, macroTask: 0, eventTask: 0 }),
        ...
        (this._interceptCurrZone = o && (o.onIntercept ? this._zone : i._interceptCurrZone)),
        (this._invokeZS = o && (o.onInvoke ? o : i._invokeZS)),
        (this._invokeDlgt = o && (o.onInvoke ? i : i._invokeDlgt)),
        (this._invokeCurrZone = o && (o.onInvoke ? this._zone : i._invokeCurrZone)),
        (this._handleErrorZS = o && (o.onHandleError ? o : i._handleErrorZS)),
        (this._handleErrorDlgt = o && (o.onHandleError ? i : i._handleErrorDlgt)),
        (this._handleErrorCurrZone = o && (o.onHandleError ? this._zone : i._handleErrorCurrZone)),
        (this._scheduleTaskZS = o && (o.onScheduleTask ? o : i._scheduleTaskZS)),
        (this._scheduleTaskDlgt = o && (o.onScheduleTask ? i : i._scheduleTaskDlgt)),
        ...
        (this._cancelTaskCurrZone = o && (o.onCancelTask ? this._zone : i._cancelTaskCurrZone)),
    ...
    fork(s, i) {
      return this._forkZS ? this._forkZS.onFork(this._forkDlgt, this.zone, s, i) : new t(s, i);
    }
    intercept(s, i, o) {
      return this._interceptZS
        ? this._interceptZS.onIntercept(this._interceptDlgt, this._interceptCurrZone, s, i, o)
        : i;
    }
    invoke(s, i, o, g, V) {
      return this._invokeZS
        ? this._invokeZS.onInvoke(this._invokeDlgt, this._invokeCurrZone, s, i, o, g, V)
        : i.apply(o, g);
    }
    handleError(s, i) {
      return this._handleErrorZS
        ? this._handleErrorZS.onHandleError(this._handleErrorDlgt, this._handleErrorCurrZone, s, i)
        : !0;
    }
    scheduleTask(s, i) {
      let o = i;
    ...
    cancelTask(s, i) {
      ...
      if (this._cancelTaskZS)
        o = this._cancelTaskZS.onCancelTask(this._cancelTaskDlgt, this._cancelTaskCurrZone, s, i);
      else {
    ...
    hasTask(s, i) {
      try {
        this._hasTaskZS &&
          this._hasTaskZS.onHasTask(this._hasTaskDlgt, this._hasTaskCurrZone, s, i);
      } catch (o) {
...
var nt = typeof WorkerGlobalScope < 'u' && self instanceof WorkerGlobalScope,
  Se = !('nw' in Y) && typeof Y.process < 'u' && Y.process.toString() === '[object process]',
...
function $e(e, n, a) {
  let t = be(e, n);
  if ((!t && a && be(a, n) && (t = { enumerable: !0, configurable: !0 }), !t || !t.configurable))
    return;
  ...
  (p || (p = Ce[T] = j('ON_PROPERTY' + T)),
    ...
    (t.get = function () {
      ...
      if (f) {
        let P = f.call(this);
        if (P) return (t.set.call(this, P), typeof C[gt] == 'function' && C.removeAttribute(n), P);
      }
      return null;
    }),
    Ae(e, n, t),
...
function vt() {
  ...
  try {
    let e = pe.navigator.userAgent;
    (e.indexOf('MSIE ') !== -1 || e.indexOf('Trident/') !== -1 || e.indexOf('Edge/') !== -1) &&
      (Me = !0);
  } catch {}
  return Me;
}
...
function Pt(e, n, a, t) {
  ...
  function J(k, d) {
    ...
    let s = function (r) {
        if (!S.isExisting) return w.call(S.target, S.eventName, S.capture ? $ : U, S.options);
      },
      i = function (r) {
        if (!r.isRemoved) {
        ...
        if (r.allRemoved) return b.call(r.target, r.eventName, r.capture ? $ : U, r.options);
      },
      o = function (r) {
      ...
      he = function (r, u) {
        let v = typeof u;
        return (
          (v === 'function' && r.callback === u) || (v === 'object' && r.originalDelegate === u)
        );
      },
      ...
      return function () {
        ...
        if (Q) {
          for (let ie = 0; ie < Q.length; ie++)
            if (L === Q[ie]) return de ? r.call(N, L, F, se) : r.apply(this, arguments);
        }
        ...
        if (Te) {
          ...
          (r.call(Te, 'abort', ie, { once: !0 }),
            (re.removeAbortListener = () => Te.removeEventListener('abort', ie)));
        }
        if (
          ((S.target = null),
          ke && (ke.taskData = null),
          ...
          for (let F = 0; F < L.length; F++) {
            ...
            if (_e(B, m)) {
              if (
                (L.splice(F, 1),
                (B.isRemoved = !0),
                L.length === 0 && ((B.allRemoved = !0), (r[N] = null), !R && typeof u == 'string'))
              ) {
...
function ye(e, n, a, t) {
  ...
  function T(C) {
    ...
    return (Qe(P) ? (_.handleId = P) : ((_.handle = P), (_.isRefreshable = Ke(P.refresh))), C);
  }
  function p(C) {
        ...
        if (Ke(P[0])) {
          ...
          P[0] = function () {
            try {
              ...
              let { handle: A, handleId: x, isPeriodic: X, isRefreshable: G } = I;
              !X && !G && (x ? delete E[x] : A && (A[Re] = null));
            }
          };
          let U = Ge(n, P[0], I, T, p);
          if (!U) return U;
          let { handleId: $, handle: J, isRefreshable: q, isPeriodic: k } = U.data;
          if ($) E[$] = U;
    ...
    (f = ue(
      ...
      (C) =>
        function (_, P) {
          let I = P[0],
            H;
          (Qe(I) ? ((H = E[I]), delete E[I]) : ((H = I?.[Re]), H ? (I[Re] = null) : (H = I)),
...
function Dt(e, n) {
  ...
  let T = e.EventTarget;
  if (!(!T || !T.prototype)) return (n.patchEventTarget(e, n, [T && T.prototype]), !0);
}
function St(e, n) {
    ...
    e.__load_patch('XHR', (n, a) => {
      ...
      function C(_) {
        ...
        function k(w) {
              ...
              if (!b.aborted && D[E] && w.state === q) {
                ...
                if (D.status !== 0 && s && s.length > 0) {
                  ...
                  ((w.invoke = function () {
                    ...
                    for (let g = 0; g < o.length; g++) o[g] === w && o.splice(g, 1);
          ...
          return (U.call(D, J, W), D[t] || (D[t] = w), z.apply(D, b.args), (D[E] = !0), w);
        }
        function d() {}
        function A(w) {
          let b = w.data;
  ...
  e.__load_patch('ZoneAwarePromise', (n, a, t) => {
    ...
    function M(h, l, r) {
      ...
      if (h[k] === y) {
        ...
        if (l !== S && r instanceof Z && r.hasOwnProperty(k) && r.hasOwnProperty(d) && r[k] !== y)
          (i(r), M(h, r[k], r[d]));
          ...
          if (
            ...
            let m = a.currentTask && a.currentTask.data && a.currentTask.data[I];
            m &&
              f(r, W, {
                configurable: !0,
                enumerable: !1,
...
` + r.stack
    ...
    function o(h, l, r, u, v) {
      i(h);
      let R = h[k],
        m = R ? (typeof u == 'function' ? u : J) : typeof v == 'function' ? v : q;
      l.scheduleMicroTask(
        G,
        () => {
          try {
    ...
    class Z {
        ...
        return new Z((m, O) => {
          for (let N = 0; N < r.length; N++)
            r[N].then(
              ...
              (L) => {
                (R.push(L), u--, u === 0 && ((v = !0), O(new ee(R, 'All promises were rejected'))));
              }
            );
        });
      }
      ...
      static allSettled(l) {
        return (this && this.prototype instanceof Z ? this : Z).allWithCallback(l, {
      ...
      constructor(l) {
        let r = this;
        if (!(r instanceof Z)) throw new Error('Must be an instanceof Promise.');
        ((r[k] = y), (r[d] = []));
        try {
          let u = D();
          l && l(u(b(r, z)), u(b(r, S)));
...
function It(e) {
  e.__load_patch('toString', (n) => {
    ...
    Object.prototype.toString = function () {
      return typeof Promise == 'function' && this instanceof Promise ? p : T.call(this);
    };
  });
}
